...
<nav class="navbar container navbar-expand-lg navbar-light">
   ...
   <div class="navbar-collapse collapse justify-content-stretch" id="navbar7">
       <ul class="navbar-nav ml-auto">
           <li class="nav-item"><!DOCTYPE html>
<html lang="en">
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
...
<!-- Breadcrumb -->
<div class="bg-breadcrumb bg-success">
    <div class="container  div-breadcrumb">
       <div class="row">
          ...
          <div class="col text-white text-right div-breadcrumb">
             <a class="text-white" href="index.html">Home</a> / Contact
          </div>
       </div>
    </div>
</div>
...
<form method="post" class="container col-md-8 col-sm-8 shadow mb-5" style="padding: 2%" >
  <div class="form-row">
    <div class="form-group col-md-6 col-sm-6">
      ...
      <span class="text-danger error"><?php echo $nameErr;?></span>
    </div>
    <div class="form-group col-md-6 col-sm-6">
      ...
      <span class="text-danger error"><?php echo $emailErr;?></span>
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <span class="text-danger error"><?php echo $subjectErr;?></span>
  </div>
  <div class="form-group">
  ...
  <span class="text-danger error"><?php echo $messageErr;?></span>
</div>
...
<!-- FOOTER -->
<footer class="pt-3 flex-shrink-0 div-bg-footer">
            ...
            <div class="col-lg-2 col-md-6 col-sm-6 col-6">
                ...
                <ul class="list-unstyled text-muted">
                    ...
                    <li>
                        <a href="#">
                            <a href="#!" class="text-reset">
                                <i class="fa-sharp fa-solid fa-chevron-right fa-2xs"></i> Marketing 
                            </a>
                        </a>
                    </li>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 col-6">
                ...
                <form action="#">                      
                    <div class="input-group mb-3">
                        ...
                        <button class="btn btn-success text-light" type="button" id="button-addon2">Subscribe</button>
                        </div>
                    </div>                           
                </form>
...
<form method="post" class="col-md-8 col-sm-8 shadow mb-5" style="padding: 2%" >
  <div class="form-row">
    <div class="form-group col-md-6 col-sm-6">
      <input name="name" type="text" value="<?php
					if (isset($_POST["name"]) && $complete != 4) {
